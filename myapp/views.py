...
def add_data(request):
    ...
    "Secondary Education", "Special Nutrition Programme", "Social Welfare", "Technical Education", "Town and Country Planning", "Tourism","Transport","Tribal Development", "University and Higher Education", "Vigilance Department", "Water Supply", 
